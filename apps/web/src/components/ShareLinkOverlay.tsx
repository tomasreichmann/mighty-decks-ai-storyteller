  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="mb-3 flex justify-center rounded-lg border border-slate-200 bg-slate-50 p-3">
          {qrDataUrl ? (
            <img
              src={qrDataUrl}
              alt={`${title} QR code`}
              className="h-56 w-56 rounded-md border border-slate-200 bg-white object-contain"
            />
          ) : (
            <div className="flex h-56 w-56 items-center justify-center text-sm text-slate-600">
        ...
        <div className="mt-3 flex items-center justify-between gap-2">
          ...
          <p
            className={cn(
              "text-xs text-slate-600 transition-opacity",
